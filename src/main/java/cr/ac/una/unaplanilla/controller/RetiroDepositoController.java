...
public class RetiroDepositoController extends Controller implements Initializable {
    ...
    public void OnActionBtnRetirar(ActionEvent actionEvent) {
        ...
        if (currentBalanceStr != null) {
            ...
            if (withdrawalAmount <= currentBalance) {
                ...
                registrarMovimiento(folio, selectedAccountType, "Retiro", withdrawalAmount);
